...
export function BlogCard() {
  ...
  return (
    <Link href='/blog/how-can-designers-prepare-for-the-future'>
      <div
        ref={wrapperDivRef}
        className={`cursor-pointer w-80 xl:w-[56rem] sm:w-[36rem] md:w-[44rem] bg-white p-5 py-14 rounded-3xl flex flex-row justify-between shadow-md ${wrapperDivEffectClassSet}`}
      >
